...
function SoullinkLogin() {
  ...
  const twitchAuthUrl = `https://id.twitch.tv/oauth2/authorize?client_id=${CLIENTID}&redirect_uri=http://${window.location.host}/Pokemon/Soullink&response_type=token&scope=user%3Aread%3Aemail`;
